...
export class DashboardV3Page implements OnInit {
  ...
  //Tabla
    ...
    {title: 'Nombre Medico', name: 'tipodocumento', filtering: {filterString: '', placeholder: 'Tipo documento'}},
    {title: 'Especialidad',      name: 'documento', filtering: {filterString: '', placeholder: 'Filtro por Documento'}, sort: 'asc'},
    {title: 'disponibilidad',  name: 'primernombre', sort: '', filtering: {filterString: '', placeholder: 'Primer nombre'}}
